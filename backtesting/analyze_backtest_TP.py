...
trading_results = pd.read_csv('backtesting/trading_results_TP.csv')
...
if len(trading_results) > 0:
    ...
    plt.savefig('backtesting/equity__ORB_5min_TP.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    df_stats.to_csv('backtesting/stats_strategy_TP.csv', index=False)
